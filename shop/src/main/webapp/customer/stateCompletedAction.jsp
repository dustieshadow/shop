<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%
    	System.out.println("----------stateCompletedAction.jsp----------");
    ...
    updateChangeCompletedOrder = OrderDAO.updateChangeCompletedOrder(ordersNo);
    
    System.out.println("updateChangeCompletedOrder :" +updateChangeCompletedOrder);
    
    if(updateChangeCompletedOrder ==1){
    	System.out.println("구매승인으로 강제상태변경 완료");
...
<head>
<meta charset="UTF-8">
<title>stateCompletedAction</title>
</head>
<body>
